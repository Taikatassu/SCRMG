...
public class GlobalVariableLibrary : MonoBehaviour {
    ...
    public GameSettingVariables gameSettingVariables;
    public ShipVariables shipVariables;
    public ProjectileVariables projectileVariables;
    public PowerUpVariables powerUpVariables;
    public SceneVariables sceneVariables;
    public UIVariables uiVariables;
    public AIVariables aiVariables;
    public NetworkingVariables networkingVariables;
    ...
    [System.Serializable]
    public class GameSettingVariables
    {
    ...
    [System.Serializable]
    public class NetworkingVariables
    {
